		...
		<div class="row">
			<div class="col-12 mt-2">
				<form class="row g-3 needs-validation" novalidate
					action="<%=request.getContextPath()%>/UpdateArticuloController?id=<%=articulo.getId()%>"
					method="POST">
					<div class="col-md-4">
						<label for="validationCustom01" class="form-label">Titulo</label>
						<input type="text" class="form-control" name="titulo"
							id="validationCustom01" value="<%=articulo.getTitulo()%>"
							placeholder="El Título" required>
					...
					<div class="col-md-4">
						<label for="validationCustom02" class="form-label">Autor</label> <input
							...
							id="validationCustom02" value="<%=articulo.getAutor()%>"
							placeholder="Perez, Juan" required>
						<div class="valid-feedback">El autor es válido.</div>
					</div>
					<div class="col-md-4">
						<label for="validationCustom03" class="form-label">Precio</label>
						<input type="number" class="form-control" name="precio"
							id="validationCustom03" value="<%=articulo.getPrecio()%>"
					...
					<div class="col-md-6">
						<label for="validationCustom04" class="form-label">Link
							...
							id="validationCustom04" value="<%=articulo.getImg()%>" required>
